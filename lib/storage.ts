...
export async function writeRankings(fighters: BoxerRecord[], worst: BoxerRecord[] = [], secondary: BoxerRecord[] = [], secondaryWorst: BoxerRecord[] = [], thirdary: BoxerRecord[] = [], thirdaryWorst: BoxerRecord[] = []): Promise<void> {
